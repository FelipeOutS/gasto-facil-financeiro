...
const INCLUDE = [
  ...
  "whatsapp-orcamento-consulta.test.ts",
  "whatsapp-recorrencias-consulta.test.ts",
  "whatsapp-contas-receber-consulta.test.ts",
  "whatsapp-transferencias-consulta.test.ts",
  "whatsapp-metas-consulta.test.ts",
  "whatsapp-query-guard.test.ts",
  "whatsapp-gastos-consulta-listar.test.ts",
  "whatsapp-gastos-por-categoria.test.ts",
  ...
  "whatsapp-c92-template-language-e1e.test.ts",
  "whatsapp-c92-canary-template-e1e.test.ts",
  "whatsapp-c92-canary-notification-helper-e1e.test.ts",
  "whatsapp-c92-ownership-strict.test.ts",
  "whatsapp-c92-attempts-d2a.test.ts",
  "whatsapp-c92-meta-transport-d2b1.test.ts",
  "whatsapp-c92-dispatcher-wiring-d2b2.test.ts",
  "whatsapp-c92-dispatcher-routes-d2b2.test.ts",
  ...
  "whatsapp-c11-f3b2b-inbound-gate.test.ts",
  "whatsapp-c11-f3b2b-notification-gate.test.ts",
  ...
  "whatsapp-c11-f3b2c1-block4-wiring.test.ts",
  ...
  "whatsapp-c11-f4b-meta-management-client.test.ts",
  "whatsapp-c11-f4b-template-resolver.test.ts",
