  ...
  const inner = (
    <div className="min-h-screen min-h-dvh w-full bg-background">
      ...
      <div className={showNav ? (collapsed ? "lg:pl-20 transition-[padding] duration-300" : "lg:pl-64 transition-[padding] duration-300") : ""}>
        <main
          className={
            "mx-auto flex w-full flex-col px-3 pt-4 pb-[calc(112px+env(safe-area-inset-bottom))] sm:px-5 md:px-6 lg:min-h-screen lg:px-6 lg:pt-5 lg:pb-12 xl:px-7 2xl:px-8 page-enter " +
            (wide
