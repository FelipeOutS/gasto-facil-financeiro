...
function Frame({
  ...
  return (
    <svg viewBox={VB} className={className} preserveAspectRatio="xMidYMid slice" aria-hidden xmlns="http://www.w3.org/2000/svg">
      <defs>
...
const ViagemInternacional: Art = ({ className }) => (
  <Frame bg={["#1e3a8a", "#0ea5e9"]} className={className}>
    ...
    <path d="M160 30 L172 70 L186 130 L196 160 H124 L134 130 L148 70 Z" fill="#0f172a" opacity="0.85" />
...
const Viagem: Art = ({ className }) => (
  <Frame bg={["#0f766e", "#fbbf24"]} className={className}>
    ...
    <rect x="150" y="60" width="20" height="20" rx="3" fill="none" stroke="#7c2d12" strokeWidth="4" />
...
const Gamer: Art = ({ className }) => (
  <Frame bg={["#0b1220", "#7c3aed"]} className={className}>
    {/* monitor */}
    <rect x="80" y="40" width="160" height="90" rx="6" fill="#0f172a" stroke="#a78bfa" strokeWidth="2" />
...
const Celular: Art = ({ className }) => (
  <Frame bg={["#1e293b", "#0ea5e9"]} className={className}>
    <rect x="125" y="30" width="70" height="120" rx="12" fill="#0f172a" stroke="#38bdf8" strokeWidth="2" />
    <rect x="132" y="42" width="56" height="92" rx="3" fill="#0ea5e9" />
    <circle cx="160" cy="142" r="3" fill="#94a3b8" />
    <path d="M145 70 L155 80 L175 60" stroke="#fff" strokeWidth="3" fill="none" strokeLinecap="round" />
...
const Carro: Art = ({ className }) => (
  <Frame bg={["#0f172a", "#ef4444"]} className={className}>
    <path d="M40 120 V100 L80 70 H230 L260 100 H280 V125 Q280 135 270 135 H50 Q40 135 40 125 Z" fill="#dc2626" />
...
const Moto: Art = ({ className }) => (
  <Frame bg={["#0b1220", "#0ea5e9"]} className={className}>
    ...
    <path d="M80 130 L130 100 L180 100 L210 70 L240 130" stroke="#0ea5e9" strokeWidth="6" fill="none" strokeLinecap="round" />
    <path d="M170 100 L200 100 L210 88" stroke="#0ea5e9" strokeWidth="6" fill="none" strokeLinecap="round" />
...
const Casamento: Art = ({ className }) => (
  <Frame bg={["#831843", "#fb7185"]} className={className}>
    ...
    {/* coração */}
    <path d="M160 60 C150 45 130 50 130 65 C130 78 160 92 160 92 C160 92 190 78 190 65 C190 50 170 45 160 60 Z" fill="#f43f5e" />
    {/* sparkles */}
...
const Saude: Art = ({ className }) => (
  <Frame bg={["#7f1d1d", "#fb7185"]} className={className}>
    ...
    <path d="M40 150 Q80 130 120 150 T 200 150 T 280 150" stroke="#fee2e2" strokeWidth="3" fill="none" />
  </Frame>
);
...
const Investimento: Art = ({ className }) => (
  <Frame bg={["#064e3b", "#34d399"]} className={className}>
    {/* gráfico subindo */}
    <path d="M30 140 L80 110 L120 125 L170 70 L220 90 L290 40" stroke="#fef3c7" strokeWidth="5" fill="none" strokeLinecap="round" strokeLinejoin="round" />
...
const KEYWORDS: Array<{ key: MetaArtKey; terms: string[] }> = [
  ...
  { key: "casamento", terms: ["casamento", "noivado", "cerimônia", "cerimonia", "festa", "lua de mel"] },
  { key: "educacao", terms: ["curso", "faculdade", "estudos", "educação", "educacao", "graduação", "graduacao", "pós", "pos", "mestrado", "mba"] },
...
export function MetaArt({
  artKey,
  className,
}: {
  artKey?: MetaArtKey | null;
  className?: string;
}) {
