      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="text-center">
            {benefit ??
              `Recurso disponível no plano ${PLAN_LABEL[min]} ou superior.`}
          </DialogDescription>
        </DialogHeader>
...
/**
 * Botão/link com cadeado: chama o handler se permitido,
 * caso contrário abre o modal de upgrade. Renderize com props mínimas.
 */
