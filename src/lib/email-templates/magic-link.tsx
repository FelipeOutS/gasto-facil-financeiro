...
export const MagicLinkEmail = ({ confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Seu link de acesso — Gasto Inteligente</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Clique no botão abaixo para acessar sua conta no <strong>Gasto Inteligente</strong>. Este
          link expira em breve.
        </Text>
