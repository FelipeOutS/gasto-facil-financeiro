...
const codeStyle = { fontFamily: 'Courier, monospace', fontSize: '28px', fontWeight: 700 as const, color: '#0f1115', letterSpacing: '4px', textAlign: 'center' as const, padding: '16px', backgroundColor: '#f5f6f8', borderRadius: '10px', margin: '20px 0' }
