    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          <strong>Gasto Inteligente</strong>. Clique no botão abaixo para criar uma nova senha. Por
          segurança, este link tem validade limitada.
        </Text>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          Se você não solicitou esta redefinição, pode ignorar este e-mail. Sua senha atual continua
          a mesma.
        </Text>
