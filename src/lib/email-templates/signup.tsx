  ...
  <Html lang="pt-BR" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Recebemos seu cadastro no <strong>Gasto Inteligente</strong>. Para
          começar a organizar suas finanças, confirme que este e-mail é seu:
          <br />
        ...
        <Text style={footerSmall}>
          ...
          <Link href={siteUrl} style={footerLink}>gastointeligente.com.br</Link>
        </Text>
      </Container>
    </Body>
  </Html>
