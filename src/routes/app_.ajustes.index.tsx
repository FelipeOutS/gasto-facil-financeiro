...
function AjustesHubPage() {
  ...
  const sections = [
    ...
    {
      id: "appearance",
      label: t("sections.appearance.title"),
    ...
    {
      id: "finance",
      label: t("sections.finance.title"),
      desc: t("sections.finance.description"),
      icon: PieChart,
      to: "/app/ajustes/preferencias-financeiras",
    },
    {
      id: "notifications",
      ...
      icon: Bell,
      to: "/app/ajustes/notificacoes",
    },
    {
      id: "privacy",
      label: t("sections.privacy.title"),
      desc: t("sections.privacy.description"),
      icon: ShieldCheck,
      to: "/app/privacidade",
    },
    {
      id: "connections",
      label: t("sections.connections.title"),
      desc: t("sections.connections.description"),
      icon: Plug,
    ...
    {
      id: "plan",
      label: t("sections.plan.title"),
      desc: t("sections.plan.description"),
      icon: Crown,
      to: "/meu-plano",
      search: { from: "ajustes" },
    },
    {
      id: "help",
      label: t("sections.help.title"),
      desc: t("sections.help.description"),
      icon: HelpCircle,
      to: "/app/ajustes/ajuda",
    },
  ];
