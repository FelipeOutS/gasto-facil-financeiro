        ...
        <div className="rounded-3xl border border-border/60 bg-card p-6 shadow-lg">
          {loading ? (
            ...
            <div className="text-center">
              ...
              <Button asChild className="mt-4"><Link to="/">{t("invite.notFound.home")}</Link></Button>
            </div>
            ...
            <div className="text-center">
              ...
              <Button asChild className="mt-4"><Link to="/">{t("invite.already.back")}</Link></Button>
            </div>
          ) : !user ? (
            <div className="text-center">
              <h1 className="text-lg font-bold">{t("invite.needLogin.title")}</h1>
              <p className="mt-2 text-sm text-muted-foreground">
                <Trans i18nKey="invite.needLogin.desc" ns="misc" values={{ email: invite.invited_email }} components={{ strong: <strong /> }} />
              </p>
              <Button asChild className="mt-4 gap-1.5">
                <Link to="/login"><LogIn className="h-4 w-4" /> {t("invite.needLogin.cta")}</Link>
              </Button>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                <Trans i18nKey="invite.wrongAccount.desc" ns="misc" values={{ email: invite.invited_email }} components={{ strong: <strong /> }} />
              </p>
            </div>
          ) : (
            <>
              ...
              <div className="mt-4 rounded-xl border border-border/60 bg-muted/30 p-4">
                <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">{t("invite.review.level")}</p>
