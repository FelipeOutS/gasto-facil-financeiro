...
export const Route = createFileRoute("/metas/$id/editar")({
  head: () => ({ meta: [{ title: "Editar meta — Gasto Inteligente" }] }),
  component: EditarMetaPage,
});

function EditarMetaPage() {
        ...
        {!ready ? (
          ...
          <div className="py-8 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Essa meta pode ter sido removida ou não está mais disponível.
            </p>
